...
const getDestination = (props) => {
    const { targetName, defaultDest = "src", distName = "destination", whenCallback = () => true, transformerCallback = (answer) => answer, } = props;
    return {
        type: "input",
        name: distName,
...
const getFileLocation = (fileName, realName, defaultValue = ".") => ({
    type: "input",
